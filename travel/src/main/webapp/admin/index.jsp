    ...
    <section class="admin_bgcolor">
        <div class="admin_login">
            <span>
                <div class="left_div">
                <ul>
                <li><input type="text" id="mid" class="input_text1" placeholder="관리자 아이디를 입력하세요"></li>
                <li><input type="password" id="mpass" class="input_text1" placeholder="관리자 패스워드를 입력하세요"></li>
                </ul>
                </div>
                <div class="right_div">
            ...
            <span>
                <ol class="admin_info">
                    <li title="신규 관리자 등록요청"><a href="./tojoin.do">신규 관리자 등록요청</a></li>
...
<script src="../admin/js/index.js?v=1"></script>
</html>