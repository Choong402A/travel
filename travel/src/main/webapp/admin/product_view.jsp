...
<div class="subpage_view">
    <span>등록된 상품 0건</span>
    <span>
        <form id="frm" method="post" action="../product/hw_p_search.do">
...
<div class="subpage_view4">
    ...
    <input type="button" value="신규상품 등록" title="신규상품 등록" class="p_button p_button_color1" onclick="location.href='./admin_product_write.do'" >
